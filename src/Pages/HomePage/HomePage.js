  ...
  return (
    <div className={styles.homepage}>
      ...
      <section className={styles.sliderContiner}>
          ...
          <div className={styles.slide}>
            ...
            <div className={styles.text}>
              ...
              <p>
                ...
                Deleniti voluptatem magni consequuntur <br /> blanditiis
                officiis laudantium vero illum quidem tempore eos.
              </p>
            </div>
        ...
        <VscFoldDown
          size={50}
          className={`${styles.down} ${visible && styles.hideDown}`}
        />
      </section>
      <Header />
          ...
          <div className={styles.box}>
            <div className={styles.description}>
              ...
              <p>
                ...
                et nemo mollitia voluptate, ipsam velit voluptas distinctio,
                enim beatae quasi autem vitae rerum ut similique saepe quibusdam
                corrupti sapiente sit doloremque fuga eius ratione incidunt!
                Sint quasi accusamus non incidunt magni ut recusandae
                reiciendis! Nam voluptate suscipit animi officia, earum quaerat,
                error quia magni esse delectus repellat tempore, quisquam eos.
                Expedita et itaque vero dicta quibusdam nulla, neque
                necessitatibus, adipisc.
              </p>
            </div>
            <div className={styles.icons}>
              ...
              <div>
                <span>
                  <MdOutlineMiscellaneousServices size={35} />
                </span>
                <span>Akıllı Servis Çözümleri</span>
              </div>
              <div>
                <span>
                  <MdOutlineSupport size={35} />
                </span>
